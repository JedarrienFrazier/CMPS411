$(document).ready(function(){
    ...
    rootRef.on("child_added", snap =>{
        ...
        //this code adds
        $('#table_body').append('<tr id="'+ key +'"><td>' + serial + '</td><td>' + type + '</td><td>' + brand + '</td><td>' + condition + '</td><td>' + mouthpiece + '</td><td>' + notes + '</td><td><button class="btn btn-danger btn-sm" id="rmbtn' + key +'">Remove</button></td><td><button class="btn btn-info btn-sm" id = "edbtn' + key +'">Edit</button></td></tr>');
    })
